{******************************************}
{*       Autor:Zejko Cvijanovic           *}
{*       E-mail: zeljko@zeljus.com        *}
{*         www.zeljus.com                 *}
{******************************************}  
...
type
  ...
  AMMicrophoneDirection = interface;
  Arr1AMMicrophoneDirection = array of AMMicrophoneDirection;
  Arr2AMMicrophoneDirection = array of Arr1AMMicrophoneDirection;
  Arr3AMMicrophoneDirection = array of Arr2AMMicrophoneDirection;

  AMAudioRecordingMonitor = interface;
  Arr1AMAudioRecordingMonitor = array of AMAudioRecordingMonitor;
  Arr2AMAudioRecordingMonitor = array of Arr1AMAudioRecordingMonitor;
  Arr3AMAudioRecordingMonitor = array of Arr2AMAudioRecordingMonitor;
  ...
  ANIpSecManager = class;
  Arr1ANIpSecManager = array of ANIpSecManager;
  Arr2ANIpSecManager = array of Arr1ANIpSecManager;
  Arr3ANIpSecManager = array of Arr2ANIpSecManager;

  ANSocketKeepalive = class;
  Arr1ANSocketKeepalive = array of ANSocketKeepalive;
  Arr2ANSocketKeepalive = array of Arr1ANSocketKeepalive;
  Arr3ANSocketKeepalive = array of Arr2ANSocketKeepalive;
  ...
  ATTelephonyScanManager = class;
  Arr1ATTelephonyScanManager = array of ATTelephonyScanManager;
  Arr2ATTelephonyScanManager = array of Arr1ATTelephonyScanManager;
  Arr3ATTelephonyScanManager = array of Arr2ATTelephonyScanManager;
  ...
  AATaskInfo = class;
  Arr1AATaskInfo = array of AATaskInfo;
  Arr2AATaskInfo = array of Arr1AATaskInfo;
  Arr3AATaskInfo = array of Arr2AATaskInfo;
  ...
  ATPrecomputedText = class;
  Arr1ATPrecomputedText = array of ATPrecomputedText;
  Arr2ATPrecomputedText = array of Arr1ATPrecomputedText;
  Arr3ATPrecomputedText = array of Arr2ATPrecomputedText;
  ...
  ATCellIdentity = class;
  Arr1ATCellIdentity = array of ATCellIdentity;
  Arr2ATCellIdentity = array of Arr1ATCellIdentity;
  Arr3ATCellIdentity = array of Arr2ATCellIdentity;
  ...
  AGRenderNode = class;
  Arr1AGRenderNode = array of AGRenderNode;
  Arr2AGRenderNode = array of Arr1AGRenderNode;
  Arr3AGRenderNode = array of Arr2AGRenderNode;

  AGFFontFamily = class;
  Arr1AGFFontFamily = array of AGFFontFamily;
  Arr2AGFFontFamily = array of Arr1AGFFontFamily;
  Arr3AGFFontFamily = array of Arr2AGFFontFamily;

  AGFFontStyle = class;
  Arr1AGFFontStyle = array of AGFFontStyle;
  Arr2AGFFontStyle = array of Arr1AGFFontStyle;
  Arr3AGFFontStyle = array of Arr2AGFFontStyle;
  ...
  AGTMeasuredText = class;
  Arr1AGTMeasuredText = array of AGTMeasuredText;
  Arr2AGTMeasuredText = array of Arr1AGTMeasuredText;
  Arr3AGTMeasuredText = array of Arr2AGTMeasuredText;

  AHCPRecommendedStreamConfigurationMap = class;
  Arr1AHCPRecommendedStreamConfigurationMap = array of AHCPRecommendedStreamConfigurationMap;
  Arr2AHCPRecommendedStreamConfigurationMap = array of Arr1AHCPRecommendedStreamConfigurationMap;
  Arr3AHCPRecommendedStreamConfigurationMap = array of Arr2AHCPRecommendedStreamConfigurationMap;

  AITBidiClassifier = class;
  Arr1AITBidiClassifier = array of AITBidiClassifier;
  Arr2AITBidiClassifier = array of Arr1AITBidiClassifier;
  Arr3AITBidiClassifier = array of Arr2AITBidiClassifier;

  AITBidiRun = class;
  Arr1AITBidiRun = array of AITBidiRun;
  Arr2AITBidiRun = array of Arr1AITBidiRun;
  Arr3AITBidiRun = array of Arr2AITBidiRun;

  AITEdits = class;
  Arr1AITEdits = array of AITEdits;
  Arr2AITEdits = array of Arr1AITEdits;
  Arr3AITEdits = array of Arr2AITEdits;
  ...
  AITTransliterator = class;
  Arr1AITTransliterator = array of AITTransliterator;
  Arr2AITTransliterator = array of Arr1AITTransliterator;
  Arr3AITTransliterator = array of Arr2AITTransliterator;
  ...
  AMAudioPlaybackCaptureConfiguration = class;
  Arr1AMAudioPlaybackCaptureConfiguration = array of AMAudioPlaybackCaptureConfiguration;
  Arr2AMAudioPlaybackCaptureConfiguration = array of Arr1AMAudioPlaybackCaptureConfiguration;
  Arr3AMAudioPlaybackCaptureConfiguration = array of Arr2AMAudioPlaybackCaptureConfiguration;

  AMAudioPresentation = class;
  Arr1AMAudioPresentation = array of AMAudioPresentation;
  Arr2AMAudioPresentation = array of Arr1AMAudioPresentation;
  Arr3AMAudioPresentation = array of Arr2AMAudioPresentation;

  AMSubtitleData = class;
  Arr1AMSubtitleData = array of AMSubtitleData;
  Arr2AMSubtitleData = array of Arr1AMSubtitleData;
  Arr3AMSubtitleData = array of Arr2AMSubtitleData;
  ...
  ANTransportInfo = interface;
  Arr1ANTransportInfo = array of ANTransportInfo;
  Arr2ANTransportInfo = array of Arr1ANTransportInfo;
  Arr3ANTransportInfo = array of Arr2ANTransportInfo;
  ...
  ASOReader = class;
  Arr1ASOReader = array of ASOReader;
  Arr2ASOReader = array of Arr1ASOReader;
  Arr3ASOReader = array of Arr2ASOReader;

  ASOSEService = class;
  Arr1ASOSEService = array of ASOSEService;
  Arr2ASOSEService = array of Arr1ASOSEService;
  Arr3ASOSEService = array of Arr2ASOSEService;

  ASOSession = class;
  Arr1ASOSession = array of ASOSession;
  Arr2ASOSession = array of Arr1ASOSession;
  Arr3ASOSession = array of Arr2ASOSession;

  ASAttestedKeyPair = class;
  Arr1ASAttestedKeyPair = array of ASAttestedKeyPair;
  Arr2ASAttestedKeyPair = array of Arr1ASAttestedKeyPair;
  Arr3ASAttestedKeyPair = array of Arr2ASAttestedKeyPair;
  ...
  ASInt64Ref = class;
  Arr1ASInt64Ref = array of ASInt64Ref;
  Arr2ASInt64Ref = array of Arr1ASInt64Ref;
  Arr3ASInt64Ref = array of Arr2ASInt64Ref;

  ASStructTimeval = class;
  Arr1ASStructTimeval = array of ASStructTimeval;
  Arr2ASStructTimeval = array of Arr1ASStructTimeval;
  Arr3ASStructTimeval = array of Arr2ASStructTimeval;

  ATNetworkScan = class;
  Arr1ATNetworkScan = array of ATNetworkScan;
  Arr2ATNetworkScan = array of Arr1ATNetworkScan;
  Arr3ATNetworkScan = array of Arr2ATNetworkScan;

  AVDisplayCutout = class;
  Arr1AVDisplayCutout = array of AVDisplayCutout;
  Arr2AVDisplayCutout = array of Arr1AVDisplayCutout;
  Arr3AVDisplayCutout = array of Arr2AVDisplayCutout;
  ...
  AVTTextClassificationSessionFactory = interface;
  Arr1AVTTextClassificationSessionFactory = array of AVTTextClassificationSessionFactory;
  Arr2AVTTextClassificationSessionFactory = array of Arr1AVTTextClassificationSessionFactory;
  Arr3AVTTextClassificationSessionFactory = array of Arr2AVTTextClassificationSessionFactory;
  ...
  AWWebViewRenderProcess = class;
  Arr1AWWebViewRenderProcess = array of AWWebViewRenderProcess;
  Arr2AWWebViewRenderProcess = array of Arr1AWWebViewRenderProcess;
  Arr3AWWebViewRenderProcess = array of Arr2AWWebViewRenderProcess;

  AWWebViewRenderProcessClient = class;
  Arr1AWWebViewRenderProcessClient = array of AWWebViewRenderProcessClient;
  Arr2AWWebViewRenderProcessClient = array of Arr1AWWebViewRenderProcessClient;
  Arr3AWWebViewRenderProcessClient = array of Arr2AWWebViewRenderProcessClient;
  ...
  AVIInspectionCompanion = interface;
  Arr1AVIInspectionCompanion = array of AVIInspectionCompanion;
  Arr2AVIInspectionCompanion = array of Arr1AVIInspectionCompanion;
  Arr3AVIInspectionCompanion = array of Arr2AVIInspectionCompanion;

  AVIPropertyMapper = interface;
  Arr1AVIPropertyMapper = array of AVIPropertyMapper;
  Arr2AVIPropertyMapper = array of Arr1AVIPropertyMapper;
  Arr3AVIPropertyMapper = array of Arr2AVIPropertyMapper;

  AVIPropertyReader = interface;
  Arr1AVIPropertyReader = array of AVIPropertyReader;
  Arr2AVIPropertyReader = array of Arr1AVIPropertyReader;
  Arr3AVIPropertyReader = array of Arr2AVIPropertyReader;
  ...
  AGBlendMode = class;
  Arr1AGBlendMode = array of AGBlendMode;
  Arr2AGBlendMode = array of Arr1AGBlendMode;
  Arr3AGBlendMode = array of Arr2AGBlendMode;
  ...
  AOSViolation = class;
  Arr1AOSViolation = array of AOSViolation;
  Arr2AOSViolation = array of Arr1AOSViolation;
  Arr3AOSViolation = array of Arr2AOSViolation;
  ...
  AOEGLImage = class;
  Arr1AOEGLImage = array of AOEGLImage;
  Arr2AOEGLImage = array of Arr1AOEGLImage;
  Arr3AOEGLImage = array of Arr2AOEGLImage;

  AOEGLSync = class;
  Arr1AOEGLSync = array of AOEGLSync;
  Arr2AOEGLSync = array of Arr1AOEGLSync;
  Arr3AOEGLSync = array of Arr2AOEGLSync;

  AADirectAction = class;
  Arr1AADirectAction = array of AADirectAction;
  Arr2AADirectAction = array of Arr1AADirectAction;
  Arr3AADirectAction = array of Arr2AADirectAction;
  ...
  AAPerson = class;
  Arr1AAPerson = array of AAPerson;
  Arr2AAPerson = array of Arr1AAPerson;
  Arr3AAPerson = array of Arr2AAPerson;
  ...
  AASSlice = class;
  Arr1AASSlice = array of AASSlice;
  Arr2AASSlice = array of Arr1AASSlice;
  Arr3AASSlice = array of Arr2AASSlice;

  AASSliceSpec = class;
  Arr1AASSliceSpec = array of AASSliceSpec;
  Arr2AASSliceSpec = array of Arr1AASSliceSpec;
  Arr3AASSliceSpec = array of Arr2AASSliceSpec;
  ...
  ABBluetoothHidDeviceAppQosSettings = class;
  Arr1ABBluetoothHidDeviceAppQosSettings = array of ABBluetoothHidDeviceAppQosSettings;
  Arr2ABBluetoothHidDeviceAppQosSettings = array of Arr1ABBluetoothHidDeviceAppQosSettings;
  Arr3ABBluetoothHidDeviceAppQosSettings = array of Arr2ABBluetoothHidDeviceAppQosSettings;

  ABBluetoothHidDeviceAppSdpSettings = class;
  Arr1ABBluetoothHidDeviceAppSdpSettings = array of ABBluetoothHidDeviceAppSdpSettings;
  Arr2ABBluetoothHidDeviceAppSdpSettings = array of Arr1ABBluetoothHidDeviceAppSdpSettings;
  Arr3ABBluetoothHidDeviceAppSdpSettings = array of Arr2ABBluetoothHidDeviceAppSdpSettings;
  ...
  ACLocusId = class;
  Arr1ACLocusId = array of ACLocusId;
  Arr2ACLocusId = array of Arr1ACLocusId;
  Arr3ACLocusId = array of Arr2ACLocusId;
  ...
  ACPModuleInfo = class;
  Arr1ACPModuleInfo = array of ACPModuleInfo;
  Arr2ACPModuleInfo = array of Arr1ACPModuleInfo;
  Arr3ACPModuleInfo = array of Arr2ACPModuleInfo;
  ...
  ACPSigningInfo = class;
  Arr1ACPSigningInfo = array of ACPSigningInfo;
  Arr2ACPSigningInfo = array of Arr1ACPSigningInfo;
  Arr3ACPSigningInfo = array of Arr2ACPSigningInfo;
  ...
  AGInsets = class;
  Arr1AGInsets = array of AGInsets;
  Arr2AGInsets = array of Arr1AGInsets;
  Arr3AGInsets = array of Arr2AGInsets;
  ...
  AMSession2Token = class;
  Arr1AMSession2Token = array of AMSession2Token;
  Arr2AMSession2Token = array of Arr1AMSession2Token;
  Arr3AMSession2Token = array of Arr2AMSession2Token;

  ANMacAddress = class;
  Arr1ANMacAddress = array of ANMacAddress;
  Arr2ANMacAddress = array of Arr1ANMacAddress;
  Arr3ANMacAddress = array of Arr2ANMacAddress;
  ...
  ANWRRangingRequest = class;
  Arr1ANWRRangingRequest = array of ANWRRangingRequest;
  Arr2ANWRRangingRequest = array of Arr1ANWRRangingRequest;
  Arr3ANWRRangingRequest = array of Arr2ANWRRangingRequest;

  ANWRResponderLocation = class;
  Arr1ANWRResponderLocation = array of ANWRResponderLocation;
  Arr2ANWRResponderLocation = array of Arr1ANWRResponderLocation;
  Arr3ANWRResponderLocation = array of Arr2ANWRResponderLocation;
  ...
  ASAUserData = class;
  Arr1ASAUserData = array of ASAUserData;
  Arr2ASAUserData = array of Arr1ASAUserData;
  Arr3ASAUserData = array of Arr2ASAUserData;

  ASNZenPolicy = class;
  Arr1ASNZenPolicy = array of ASNZenPolicy;
  Arr2ASNZenPolicy = array of Arr1ASNZenPolicy;
  Arr3ASNZenPolicy = array of Arr2ASNZenPolicy;

  ATNetworkScanRequest = class;
  Arr1ATNetworkScanRequest = array of ATNetworkScanRequest;
  Arr2ATNetworkScanRequest = array of Arr1ATNetworkScanRequest;
  Arr3ATNetworkScanRequest = array of Arr2ATNetworkScanRequest;

  ATRadioAccessSpecifier = class;
  Arr1ATRadioAccessSpecifier = array of ATRadioAccessSpecifier;
  Arr2ATRadioAccessSpecifier = array of Arr1ATRadioAccessSpecifier;
  Arr3ATRadioAccessSpecifier = array of Arr2ATRadioAccessSpecifier;
  ...
  ATDApnSetting = class;
  Arr1ATDApnSetting = array of ATDApnSetting;
  Arr2ATDApnSetting = array of Arr1ATDApnSetting;
  Arr3ATDApnSetting = array of Arr2ATDApnSetting;

  ATEDownloadableSubscription = class;
  Arr1ATEDownloadableSubscription = array of ATEDownloadableSubscription;
  Arr2ATEDownloadableSubscription = array of Arr1ATEDownloadableSubscription;
  Arr3ATEDownloadableSubscription = array of Arr2ATEDownloadableSubscription;

  ATEEuiccInfo = class;
  Arr1ATEEuiccInfo = array of ATEEuiccInfo;
  Arr2ATEEuiccInfo = array of Arr1ATEEuiccInfo;
  Arr3ATEEuiccInfo = array of Arr2ATEEuiccInfo;

  ATMDownloadRequest = class;
  Arr1ATMDownloadRequest = array of ATMDownloadRequest;
  Arr2ATMDownloadRequest = array of Arr1ATMDownloadRequest;
  Arr3ATMDownloadRequest = array of Arr2ATMDownloadRequest;

  ATMFileInfo = class;
  Arr1ATMFileInfo = array of ATMFileInfo;
  Arr2ATMFileInfo = array of Arr1ATMFileInfo;
  Arr3ATMFileInfo = array of Arr2ATMFileInfo;
  ...
  AVCDataRemovalRequest = class;
  Arr1AVCDataRemovalRequest = array of AVCDataRemovalRequest;
  Arr2AVCDataRemovalRequest = array of Arr1AVCDataRemovalRequest;
  Arr3AVCDataRemovalRequest = array of Arr2AVCDataRemovalRequest;

  AVTTextClassificationContext = class;
  Arr1AVTTextClassificationContext = array of AVTTextClassificationContext;
  Arr2AVTTextClassificationContext = array of Arr1AVTTextClassificationContext;
  Arr3AVTTextClassificationContext = array of Arr2AVTTextClassificationContext;

  AVTTextClassificationSessionId = class;
  Arr1AVTTextClassificationSessionId = array of AVTTextClassificationSessionId;
  Arr2AVTTextClassificationSessionId = array of Arr1AVTTextClassificationSessionId;
  Arr3AVTTextClassificationSessionId = array of Arr2AVTTextClassificationSessionId;
  ...
  ATMFileServiceInfo = class;
  Arr1ATMFileServiceInfo = array of ATMFileServiceInfo;
  Arr2ATMFileServiceInfo = array of Arr1ATMFileServiceInfo;
  Arr3ATMFileServiceInfo = array of Arr2ATMFileServiceInfo;
  ...
  ATMGroupCall = class;
  Arr1ATMGroupCall = array of ATMGroupCall;
  Arr2ATMGroupCall = array of Arr1ATMGroupCall;
  Arr3ATMGroupCall = array of Arr2ATMGroupCall;

  ATMStreamingService = class;
  Arr1ATMStreamingService = array of ATMStreamingService;
  Arr2ATMStreamingService = array of Arr1ATMStreamingService;
  Arr3ATMStreamingService = array of Arr2ATMStreamingService;

  AVCContentCaptureSession = class;
  Arr1AVCContentCaptureSession = array of AVCContentCaptureSession;
  Arr2AVCContentCaptureSession = array of Arr1AVCContentCaptureSession;
  Arr3AVCContentCaptureSession = array of Arr2AVCContentCaptureSession;
  ...
  AHCPSessionConfiguration = class;
  Arr1AHCPSessionConfiguration = array of AHCPSessionConfiguration;
  Arr2AHCPSessionConfiguration = array of Arr1AHCPSessionConfiguration;
  Arr3AHCPSessionConfiguration = array of Arr2AHCPSessionConfiguration;
  ...
  AVSurfaceControl = class;
  Arr1AVSurfaceControl = array of AVSurfaceControl;
  Arr2AVSurfaceControl = array of Arr1AVSurfaceControl;
  Arr3AVSurfaceControl = array of Arr2AVSurfaceControl;
  ...
  ANIpSecTransform = class;
  Arr1ANIpSecTransform = array of ANIpSecTransform;
  Arr2ANIpSecTransform = array of Arr1ANIpSecTransform;
  Arr3ANIpSecTransform = array of Arr2ANIpSecTransform;
  ...
  AGRecordingCanvas = class;
  Arr1AGRecordingCanvas = array of AGRecordingCanvas;
  Arr2AGRecordingCanvas = array of Arr1AGRecordingCanvas;
  Arr3AGRecordingCanvas = array of Arr2AGRecordingCanvas;
  ...
  ASOChannel = class;
  Arr1ASOChannel = array of ASOChannel;
  Arr2ASOChannel = array of Arr1ASOChannel;
  Arr3ASOChannel = array of Arr2ASOChannel;
  ...
  AVTTextLinks = class;
  Arr1AVTTextLinks = array of AVTTextLinks;
  Arr2AVTTextLinks = array of Arr1AVTTextLinks;
  Arr3AVTTextLinks = array of Arr2AVTTextLinks;
  ...
  AVTConversationActions = class;
  Arr1AVTConversationActions = array of AVTConversationActions;
  Arr2AVTConversationActions = array of Arr1AVTConversationActions;
  Arr3AVTConversationActions = array of Arr2AVTConversationActions;

  AHLutProperties = class;
  Arr1AHLutProperties =  array of AHLutProperties;
  Arr2AHLutProperties =  array of Arr1AHLutProperties;
  Arr3AHLutProperties =  array of Arr2AHLutProperties;
  ...
  ACRLResourcesLoader = class;
  Arr1ACRLResourcesLoader = array of ACRLResourcesLoader;
  Arr2ACRLResourcesLoader = array of Arr1ACRLResourcesLoader;
  Arr3ACRLResourcesLoader = array of Arr2ACRLResourcesLoader;

  ACPAttribution = class;
  Arr1ACPAttribution = array of ACPAttribution;
  Arr2ACPAttribution = array of Arr1ACPAttribution;
  Arr3ACPAttribution = array of Arr2ACPAttribution;

  JURRandomGenerator_InnerJumpableGenerator = interface;
  Arr1JURRandomGenerator_InnerJumpableGenerator = array of JURRandomGenerator_InnerJumpableGenerator;
  Arr2JURRandomGenerator_InnerJumpableGenerator = array of Arr1JURRandomGenerator_InnerJumpableGenerator;
  Arr3JURRandomGenerator_InnerJumpableGenerator = array of Arr2JURRandomGenerator_InnerJumpableGenerator;

  JURRandomGenerator_InnerLeapableGenerator = interface;
  Arr1JURRandomGenerator_InnerLeapableGenerator = array of JURRandomGenerator_InnerLeapableGenerator;
  Arr2JURRandomGenerator_InnerLeapableGenerator = array of Arr1JURRandomGenerator_InnerLeapableGenerator;
  Arr3JURRandomGenerator_InnerLeapableGenerator = array of Arr2JURRandomGenerator_InnerLeapableGenerator;

  JURRandomGenerator_InnerArbitrarilyJumpableGenerator = interface;
  Arr1JURRandomGenerator_InnerArbitrarilyJumpableGenerator = array of JURRandomGenerator_InnerArbitrarilyJumpableGenerator;
  Arr2JURRandomGenerator_InnerArbitrarilyJumpableGenerator = array of Arr1JURRandomGenerator_InnerArbitrarilyJumpableGenerator;
  Arr3JURRandomGenerator_InnerArbitrarilyJumpableGenerator = array of Arr2JURRandomGenerator_InnerArbitrarilyJumpableGenerator;

   ASStructCmsghdr = class;
   Arr1ASStructCmsghdr = array of  ASStructCmsghdr;

   AAAAppSearchBlobHandle = class;
   Arr1AAAAppSearchBlobHandle = array of AAAAppSearchBlobHandle;

   AAAGenericDocument = class;
   Arr1AAAGenericDocument = array of AAAGenericDocument;

   AAAEmbeddingVector = class;
   Arr1AAAEmbeddingVector = array of AAAEmbeddingVector;

   JLITypeDescriptor_InnerOfMethod = interface;
   Arr1JLITypeDescriptor_InnerOfMethod = array of JLITypeDescriptor_InnerOfMethod;
   Arr2JLITypeDescriptor_InnerOfMethod = array of Arr1JLITypeDescriptor_InnerOfMethod;
   Arr3JLITypeDescriptor_InnerOfMethod = array of Arr2JLITypeDescriptor_InnerOfMethod;

   JLITypeDescriptor_InnerOfField = interface;
   Arr1JLITypeDescriptor_InnerOfField = array of JLITypeDescriptor_InnerOfField;
   Arr2JLITypeDescriptor_InnerOfField = array of Arr1JLITypeDescriptor_InnerOfField;
   Arr3JLITypeDescriptor_InnerOfField = array of Arr2JLITypeDescriptor_InnerOfField;

   AAAAppSearchSchema = class;
   Arr1AAAAppSearchSchema = array of AAAAppSearchSchema;


   AITDisplayOptions = class;

   AINNumberRangeFormatter_InnerRangeIdentityResult = class;
   Arr1AINNumberRangeFormatter_InnerRangeIdentityResult = array of AINNumberRangeFormatter_InnerRangeIdentityResult;
   Arr2AINNumberRangeFormatter_InnerRangeIdentityResult = array of Arr1AINNumberRangeFormatter_InnerRangeIdentityResult;
   Arr3AINNumberRangeFormatter_InnerRangeIdentityResult = array of Arr2AINNumberRangeFormatter_InnerRangeIdentityResult;

   AINNumberRangeFormatter_InnerRangeCollapse = class;
   Arr1AINNumberRangeFormatter_InnerRangeCollapse = array of AINNumberRangeFormatter_InnerRangeCollapse;
   Arr2AINNumberRangeFormatter_InnerRangeCollapse = array of Arr1AINNumberRangeFormatter_InnerRangeCollapse;
   Arr3AINNumberRangeFormatter_InnerRangeCollapse = array of Arr2AINNumberRangeFormatter_InnerRangeCollapse;

   AINNumberRangeFormatter_InnerRangeIdentityFallback = class;
   Arr1AINNumberRangeFormatter_InnerRangeIdentityFallback = array of AINNumberRangeFormatter_InnerRangeIdentityFallback;
   Arr2AINNumberRangeFormatter_InnerRangeIdentityFallback = array of Arr1AINNumberRangeFormatter_InnerRangeIdentityFallback;
   Arr3AINNumberRangeFormatter_InnerRangeIdentityFallback = array of Arr2AINNumberRangeFormatter_InnerRangeIdentityFallback;

   ACContext_InnerBindServiceFlags = class;
   Arr1ACContext_InnerBindServiceFlags = array of ACContext_InnerBindServiceFlags;
   Arr2ACContext_InnerBindServiceFlags = array of Arr1ACContext_InnerBindServiceFlags;
   Arr3ACContext_InnerBindServiceFlags = array of Arr2ACContext_InnerBindServiceFlags;

   AVSurfaceControl_InnerTransaction = class;
   Arr1AVSurfaceControl_InnerTransaction = array of AVSurfaceControl_InnerTransaction;
   Arr2AVSurfaceControl_InnerTransaction = array of Arr1AVSurfaceControl_InnerTransaction;
   Arr3AVSurfaceControl_InnerTransaction = array of Arr2AVSurfaceControl_InnerTransaction;

   AVSurfaceControl_InnerTrustedPresentationThresholds = class;
   Arr1AVSurfaceControl_InnerTrustedPresentationThresholds = array of AVSurfaceControl_InnerTrustedPresentationThresholds;
   Arr2AVSurfaceControl_InnerTrustedPresentationThresholds = array of Arr1AVSurfaceControl_InnerTrustedPresentationThresholds;
   Arr3AVSurfaceControl_InnerTrustedPresentationThresholds = array of Arr2AVSurfaceControl_InnerTrustedPresentationThresholds;

   AVSurfaceControl_InnerTransactionCommittedListener = interface;
   Arr1AVSurfaceControl_InnerTransactionCommittedListener = array of AVSurfaceControl_InnerTransactionCommittedListener;
   Arr2AVSurfaceControl_InnerTransactionCommittedListener = array of Arr1AVSurfaceControl_InnerTransactionCommittedListener;
   Arr3AVSurfaceControl_InnerTransactionCommittedListener = array of Arr2AVSurfaceControl_InnerTransactionCommittedListener;

   AVSurfaceControl_InnerOnJankDataListener = interface;
   Arr1AVSurfaceControl_InnerOnJankDataListener = array of AVSurfaceControl_InnerOnJankDataListener;
   Arr2AVSurfaceControl_InnerOnJankDataListener = array of Arr1AVSurfaceControl_InnerOnJankDataListener;
   Arr3AVSurfaceControl_InnerOnJankDataListener = array of Arr2AVSurfaceControl_InnerOnJankDataListener;

   AVSurfaceControl_InnerOnJankDataListenerRegistration = class;
   Arr1AVSurfaceControl_InnerOnJankDataListenerRegistration = array of AVSurfaceControl_InnerOnJankDataListenerRegistration;
   Arr2AVSurfaceControl_InnerOnJankDataListenerRegistration = array of Arr1AVSurfaceControl_InnerOnJankDataListenerRegistration;
   Arr3AVSurfaceControl_InnerOnJankDataListenerRegistration = array of Arr2AVSurfaceControl_InnerOnJankDataListenerRegistration;

   AMAudioMetadata_InnerKey = interface;
   Arr1AMAudioMetadata_InnerKey = array of AMAudioMetadata_InnerKey;
   Arr2AMAudioMetadata_InnerKey = array of Arr1AMAudioMetadata_InnerKey;
   Arr3AMAudioMetadata_InnerKey = array of Arr2AMAudioMetadata_InnerKey;

   AOIBinder_InnerFrozenStateChangeCallback = interface;
   Arr1AOIBinder_InnerFrozenStateChangeCallback = array of AOIBinder_InnerFrozenStateChangeCallback;
   Arr2AOIBinder_InnerFrozenStateChangeCallback = array of Arr1AOIBinder_InnerFrozenStateChangeCallback;
   Arr3AOIBinder_InnerFrozenStateChangeCallback = array of Arr2AOIBinder_InnerFrozenStateChangeCallback;

   ATLayout_InnerTextInclusionStrategy = interface;
   Arr1ATLayout_InnerTextInclusionStrategy = array of ATLayout_InnerTextInclusionStrategy;
   Arr2ATLayout_InnerTextInclusionStrategy = array of Arr1ATLayout_InnerTextInclusionStrategy;
   Arr3ATLayout_InnerTextInclusionStrategy = array of Arr2ATLayout_InnerTextInclusionStrategy;

  AVSurfaceControlViewHost_InnerSurfacePackage = class;
  Arr1AVSurfaceControlViewHost_InnerSurfacePackage = array of AVSurfaceControlViewHost_InnerSurfacePackage;
  Arr2AVSurfaceControlViewHost_InnerSurfacePackage = array of Arr1AVSurfaceControlViewHost_InnerSurfacePackage;
  Arr3AVSurfaceControlViewHost_InnerSurfacePackage = array of Arr2AVSurfaceControlViewHost_InnerSurfacePackage;

  AVContextMenu_InnerContextMenuInfo = interface;
  Arr1AVContextMenu_InnerContextMenuInfo = array of AVContextMenu_InnerContextMenuInfo;
  Arr2AVContextMenu_InnerContextMenuInfo = array of Arr1AVContextMenu_InnerContextMenuInfo;
  Arr3AVContextMenu_InnerContextMenuInfo = array of Arr2AVContextMenu_InnerContextMenuInfo;

  AGPorterDuff_InnerMode = class;
  Arr1AGPorterDuff_InnerMode = array of AGPorterDuff_InnerMode;
  Arr2AGPorterDuff_InnerMode = array of Arr1AGPorterDuff_InnerMode;
  Arr3AGPorterDuff_InnerMode = array of Arr2AGPorterDuff_InnerMode;

  AVKeyEvent_InnerDispatcherState = class;
  Arr1AVKeyEvent_InnerDispatcherState = array of AVKeyEvent_InnerDispatcherState;
  Arr2AVKeyEvent_InnerDispatcherState = array of Arr1AVKeyEvent_InnerDispatcherState;
  Arr3AVKeyEvent_InnerDispatcherState = array of Arr2AVKeyEvent_InnerDispatcherState;

  AVAAnimation_InnerAnimationListener = interface;
  Arr1AVAAnimation_InnerAnimationListener = array of AVAAnimation_InnerAnimationListener;
  Arr2AVAAnimation_InnerAnimationListener = array of Arr1AVAAnimation_InnerAnimationListener;
  Arr3AVAAnimation_InnerAnimationListener = array of Arr2AVAAnimation_InnerAnimationListener;

  AVViewGroup_InnerLayoutParams = class;
  Arr1AVViewGroup_InnerLayoutParams = array of AVViewGroup_InnerLayoutParams;
  Arr2AVViewGroup_InnerLayoutParams = array of Arr1AVViewGroup_InnerLayoutParams;
  Arr3AVViewGroup_InnerLayoutParams = array of Arr2AVViewGroup_InnerLayoutParams;

  AVViewGroup_InnerMarginLayoutParams = class;
  Arr1AVViewGroup_InnerMarginLayoutParams = array of AVViewGroup_InnerMarginLayoutParams;
  Arr2AVViewGroup_InnerMarginLayoutParams = array of Arr1AVViewGroup_InnerMarginLayoutParams;
  Arr3AVViewGroup_InnerMarginLayoutParams = array of Arr2AVViewGroup_InnerMarginLayoutParams;

  AITDisplayOptions_InnerNounClass = class;
  Arr1AITDisplayOptions_InnerNounClass = array of AITDisplayOptions_InnerNounClass;
  Arr2AITDisplayOptions_InnerNounClass = array of Arr1AITDisplayOptions_InnerNounClass;
  Arr3AITDisplayOptions_InnerNounClass = array of Arr2AITDisplayOptions_InnerNounClass;

{$include androidr36.inc}
